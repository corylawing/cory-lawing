...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      pt1: 'Petites vacances : la rédaction reprend celle de la période scolaire, avec l’échange du vendredi à la sortie des classes. C’est donc l’alternance du vendredi qui se poursuit, identifiée par la même semaine civile qu’en période scolaire. La formule « par semaine complète », qui ferait tomber l’échange le dimanche, n’a pas été retenue ; elle reste disponible dans les réglages à titre de comparaison. L’écart entre les deux est de trois jours par période.',
      ...
      hwFri: 'Alternance du vendredi qui continue (retenu)',
      hwCal: 'Semaines civiles entières, lundi → dimanche (comparaison)',
      sHolWeeksH: 'Alternance du vendredi : le rythme de la période scolaire se poursuit sans changement, avec l’échange du vendredi. C’est la lecture cohérente avec la rédaction retenue. Semaines civiles entières : l’échange tombe le dimanche soir ; c’est la formule « par semaine complète » qui avait été demandée mais n’a pas été retenue. Proposée ici pour comparer les deux, l’écart étant de trois jours par période.',
    ...
    en: {
      ...
      pt1: 'Half-term holidays: the wording repeats that of term time, with the Friday changeover at the end of the school day. So the Friday alternation carries on, identified by the same civil week as in term time. The "whole week" formulation, which would move the handover to Sunday, was not retained; it stays available in the settings for comparison. Three days per holiday separate the two.',
      ...
      hwFri: 'The Friday rotation continues (as ordered)',
      hwCal: 'Whole civil weeks, Monday → Sunday (for comparison)',
      sHolWeeksH: 'Friday rotation: the term-time rhythm carries on unchanged, with the Friday changeover. This is the reading consistent with the wording as ordered. Whole civil weeks: the handover falls on Sunday evening; this is the "whole week" formulation that was requested but not retained. Offered here so the two can be compared — three days per holiday separate them.',
