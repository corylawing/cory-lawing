...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      r5: 'Vacances d’été : huit semaines. Les 1re, 2e, 3e et la 7e chez {a} les années paires, les 4e, 5e, 6e et la 8e chez {b} ; inversement les années impaires. La 1re semaine commence au premier jour des vacances. Les quelques jours qui restent à la fin, huit semaines ne couvrant jamais exactement l’été, restent chez le parent de la 8e semaine — laquelle change chaque année, ce qui équilibre le compte dans le temps.',
    ...
    en: {
      ...
      r5: 'Summer holidays: eight weeks. The 1st, 2nd, 3rd and 7th with {a} in even years, the 4th, 5th, 6th and 8th with {b}; reversed in odd years. Week one starts on the first day of the holidays. The few days left at the end — eight weeks never covering a summer exactly — stay with the eighth week’s parent, and since that alternates each year the count stays level over time.',
