...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      r5: 'Vacances d’été : huit semaines. Les 1re, 2e, 3e et la 7e chez {a} les années paires, les 4e, 5e, 6e et la 8e chez {b} ; inversement les années impaires. Les huit semaines sont des semaines civiles : la 1re commence le premier lundi des vacances. Huit semaines ne couvrant jamais exactement l’été, les jours qui restent à la fin restent chez le parent de la 8e semaine, jusqu’à la rentrée. Aucun échange n’est créé à la fin du mois d’août.',
    ...
    en: {
      ...
      r5: 'Summer holidays: eight weeks. The 1st, 2nd, 3rd and 7th with {a} in even years, the 4th, 5th, 6th and 8th with {b}; reversed in odd years. The eight weeks are civil weeks: week one starts on the first Monday of the holidays. Since eight weeks never covers a summer exactly, the days left at the end stay with the eighth week’s parent, through to the start of the school year. No changeover is created at the end of August.',
