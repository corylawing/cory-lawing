...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      r2: 'La semaine paire va du vendredi de cette semaine paire au vendredi suivant : c’est ce vendredi-là que les enfants sont récupérés. À la sortie des classes en période scolaire ({t}), à {h} pendant les vacances, puisqu’il n’y a pas de classe.',
      ...
      r5: 'Vacances d’été : huit semaines. Les 1re, 2e, 3e et la 7e chez {a} les années paires, les 4e, 5e, 6e et la 8e chez {b} ; inversement les années impaires. Les huit semaines vont du dimanche au dimanche : la 1re commence le premier dimanche des vacances, et chaque changement se fait un dimanche. Huit semaines ne couvrant jamais exactement l’été, les jours qui restent à la fin restent chez le parent de la 8e semaine, jusqu’à la rentrée. Aucun échange n’est créé à la fin du mois d’août.',
    ...
    en: {
      ...
      r2: 'An even week runs from the Friday of that even week to the following Friday: that is the Friday the children are collected. At the end of the school day in term time ({t}), at {h} during the holidays, since there is no school.',
      ...
      r5: 'Summer holidays: eight weeks. The 1st, 2nd, 3rd and 7th with {a} in even years, the 4th, 5th, 6th and 8th with {b}; reversed in odd years. The eight weeks run Sunday to Sunday: week one starts on the first Sunday of the holidays, and each changeover falls on a Sunday. Since eight weeks never covers a summer exactly, the days left at the end stay with the eighth week’s parent, through to the start of the school year. No changeover is created at the end of August.',
