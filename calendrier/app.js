...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      r5: 'Vacances d’été : huit semaines. Les 1re, 2e, 3e et la 7e chez {a} les années paires, les 4e, 5e, 6e et la 8e chez {b} ; inversement les années impaires. Les huit semaines sont les huit semaines civiles complètes des vacances : la première commence le premier lundi. Les jours restants suivent l’alternance paire / impaire.',
    ...
    en: {
      ...
      r5: 'Summer holidays: eight weeks. The 1st, 2nd, 3rd and 7th with {a} in even years, the 4th, 5th, 6th and 8th with {b}; reversed in odd years. The eight weeks are the eight full civil weeks of the break, so week one starts on its first Monday. Any remaining days follow the even/odd alternation.',
